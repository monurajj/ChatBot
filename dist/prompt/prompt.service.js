...
let PromptService = class PromptService {
    async getPromptResponse(prompt) {
        const response = await axios_1.default.post('https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-latest:generateContent?key=AIzaSyCMcb2wx1sozgiNfqqiarxD3dy7dd3EyH0', { contents: [{ parts: [{ text: prompt }] }] });
